            ...
            <div className="sql-manage-detail-header">
                <div className="header-left">
                    <Select
                        ...
                        className={ methodToClass[data.method || 'MySQL'] }
                        onChange={(e) => {
                            onChange('method', e);
                        }}
                    >
                        ...
                        <Option style={{ color: 'var(--oracle)' }} key='ORACLE' value='ORACLE'>
                            ORACLE
                        </Option>
                        <Option style={{ color: 'var(--postgresql)' }} key='PgSQL' value='PgSQL'>
                            PgSQL
                        </Option>
                    </Select>
                    <InputText
                ...
                <div className="header-right">
                    ...
                    <Button loading={runLoading} className='run-btn' icon={<SvgCareRight />} onClick={runMysql}>
                        执行
                    </Button>
                    <ButtonGroup>
                        <Button className="save-btn" onClick={() => saveMysql(data.parent_id ? data.parent_id : '')}><SvgSave /> {t('btn.save')}</Button>
